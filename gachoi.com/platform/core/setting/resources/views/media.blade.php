...
@section('content')
    ...
    <div class="max-width-1200">
        ...
        <div class="flexbox-annotated-section" style="border: none">
            ...
            <div class="flexbox-annotated-section-content">
                ...
                <button class="btn btn-danger delete-generate-thumbnails-trigger-button" type="button" data-saving="{{ trans('core/setting::setting.saving') }}">{{ trans('core/setting::setting.delete_generate_thumbnails') }}</button>
            </div>
        </div>
    </div>
    {!! Form::close() !!}
    ...
    {!! Form::modalAction('delete-generate-thumbnails-modal', trans('core/setting::setting.delete_generate_thumbnails'), 'danger', trans('core/setting::setting.delete_generate_thumbnails_description'), 'delete-generate-thumbnails-button', trans('core/setting::setting.delete')) !!}
@endsection
