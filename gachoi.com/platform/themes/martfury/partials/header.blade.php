            ...
            <nav class="navigation">
                <div class="header-container">
                    <div class="header-left">
                        <span>
			     	        Đường 93 Thôn Tuấn Xuyên xã Vạn Thắng, huyện Ba Vì, tp Hà Nội | 0928 628 777
                        </span>
                    ...
                    <div class="header-right">
                        <div class="ps-block--user-header">
                            ...
                            <div class="ps-block__right">
                                ...
                                @else
                                    <a href="{{ route('customer.login') }}">{{ __('Đăng nhập') }}</a><a href="{{ route('customer.register') }}">{{ __('Đăng kí') }}</a>
                                @endif
                            </div>
                        </div>
